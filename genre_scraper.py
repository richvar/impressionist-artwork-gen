...
parser.add_argument("--style", help="which style to scrape", choices=style_list, default='impressionism')
parser.add_argument("--num_pages", type=int, help="number of pages to scrape (leave blank to download all of them)", default=1000)
parser.add_argument("--output_dir", help="where to put output files", default = "Insert:Directory/Here/to/folder/")
